...
public class Config {
    ...
    private void readData() {
        ...
        for (String line : lines) {
            ...
            String[] parts = line.split(":");  //cắt đến những vị trí có dấu : rồi ngừng, nếu có dấu : thì cắt tiếp.
            if (line.indexOf("ACCOUN") >= 0) //Phương thức indexOf() thường được sử dụng trong các trường hợp chúng ta muốn tìm vị trí xuất hiện đầu tiên của một ký tự
            {
